  ...
  <div class="container1 ">
    <div class="row">
      <div class="col-12">
          ...
          <input class=" form-group in"  type="text" placeholder="Nhập tên đăng nhập" name="tendn"  value="<?php echo $ten; ?>">
          <input type="password" class="form-group in" placeholder="Nhập mật khẩu" name="mk" >
