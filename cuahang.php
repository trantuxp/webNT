...
<body>
	...
	<form action="capnhatcuahang.php" method="POST" >
		...
		<!-- Link ảnh cũ : --> <input type="hidden" name="anhcu" required value="<?php echo $row['anh'];?>" style="width: 50%" ><br>
		<!-- Link ảnh mới:  --><input type="hidden" id="myfile"required name="anh" ><!-- <br>
