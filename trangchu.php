			...
			<div class="row ">
				...
				<div class="col-4 ">
					...
					<table class="table bg-white">
						<tr> 
							<td width="70%">
								<a href="chitiettintuc.php?idtin=<?php echo $row_tinmoi['id']; ?>" title=""><img src="img/<?php echo $row_tinmoi['anh']; ?>" alt="" width="80%" height="300px"></a>
							</td>
							<td>
				...
				<div class="col-4 ">
					...
					<table class="table bg-white">
						<tr> 
							<td width="70%">
								<a href="chitiettintuc.php?idtin=<?php echo $row_tinhot['id']; ?>" title=""><img src="img/<?php echo $row_tinhot['anh']; ?>" alt="" width="80%" height="300px"></a>
							</td>
							<td>
				...
				<div class="col-4">
					...
					<table class="table bg-white">
						<tr> 
							<td width="70%">
								<a href="chitiettintuc.php?idtin=<?php echo $row_tinNoibat['id']; ?>" title="" >
									<img height="300px" src="img/<?php echo $row_tinNoibat['anh']; ?>" alt=""  >
								</a>
							</td>
							<td>
